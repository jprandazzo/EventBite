...
export default function EventsSearch () {
    ...
    const heartIcon = (e) => {
        if (currentUser && !currentUser.likedEvents.includes(e.id)) {
                    ...
                    {allEvents?.map((ev,i)=>{
                        return(
                            <div className='search-event-tile' id={`search-event-tile-${i}`}>
                                ...
                                <div className='search-event-tile-title'><Link to={`/events/${ev.id}`}>{ev.title?.toUpperCase()}</Link></div>
                                ...
                                <div className='search-event-tile-organizer-name'>{ev.organizerName}</div>
